...
It contains PHP7.4.14 with plenty of common and useful extensions.

If you want to try out latest PHP8.0, head over to
[`adhocore/phpfpm:8.0`](https://github.com/adhocore/docker-phpfpm/tree/8.0).
